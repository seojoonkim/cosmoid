export default function WhyCosmoid() {
  return (
    <section className="py-32 px-6 bg-[#0d0d18]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 glass rounded-full px-4 py-2 text-sm text-purple-400 mb-6 font-medium">
            💡 왜 Cosmoid인가
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="glass rounded-3xl p-10">
            ...
            <h3 className="text-2xl font-black mb-6 text-slate-300">기존 AI 비서의 현실</h3>
          ...
          {/* Solution side */}
          <div className="rounded-3xl p-10 relative overflow-hidden" style={{background:"linear-gradient(135deg, rgba(124,58,237,0.15), rgba(6,182,212,0.1))", border:"1px solid rgba(124,58,237,0.3)"}}>
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(124,58,237,0.15),transparent_70%)]" />
            <div className="relative z-10">
              <div className="text-3xl mb-4">🚀</div>
              <h3 className="text-2xl font-black mb-6 text-white">Cosmoid는 달라요</h3>
              <ul className="space-y-4">
                {[
        ...
        <div className="text-center glass rounded-3xl p-10">
          ...
          <p className="text-slate-500 text-sm">— OpenClaw 기반으로 구축된 유일한 한국어 B2C AI 비서</p>
        </div>
      </div>
    </section>
  );
