...
export default function Pricing() {
  return (
    <section id="pricing" className="bg-[var(--bg-alt)] [background:linear-gradient(160deg,#f0ebff_0%,#e6deff_50%,#f0ebff_100%)] border-t border-[var(--border)] py-16 md:py-24">
...
style={{ background: "white", border: "1px solid var(--border)", color: "var(--text)" }}
            >
              ...
              <p className="text-3xl md:text-4xl font-black mb-1" style={{color:"var(--purple)"}}>
                {plan.price}
